...
<title>Cumulative Credit Note</title>
...
<body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0"
		...
		<tr>
			<td width="100%" colspan="12" align="left"
				style="border-top: 1px solid #313131; padding: 4px; font-size: 10px; font-weight: bold;">&nbsp;&nbsp;${FACTORYADDRESS}&nbsp;GSTIN
...
<br></br>  --%>
				...
				<tr>
					...
					<td align="right"
						style="border-left: 1px solid #313131; border-bottom: 1px solid #313131; padding: 4px; color: #000; font-size: 12px;"><b><fmt:formatNumber
								...
								value="${totalAmt+totalCgst+totalSgst}" var="netValueFinal" />${netValueFinal}</b></td>
				</tr>
					...
					<tr>
						...
						<td align="right"
							style="border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 3px 4px; color: #000; font-size: 10px;"><fmt:formatNumber
								type="number" groupingUsed="false" maxFractionDigits="2"
								minFractionDigits="2"
								value="${crnDetailsSummaryList.taxableAmt}" /></td>
						<td align="right"
							style="border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 3px 4px; color: #000; font-size: 10px;"><fmt:formatNumber
								type="number" groupingUsed="false" maxFractionDigits="2"
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0"
		...
		<c:forEach items="${totalSummaryList}" var="totalSummaryList"
			...
			<tr>
				<td
					style="border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 3px 5px; color: #000; font-size: 10px;"><c:out
						value="${totalSummaryList.value.itemHsncd}"></c:out></td>

				<td
					style="border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 3px 5px; color: #000; font-size: 10px;"><c:out
						value="${totalSummaryList.value.itemHsncdesc}"></c:out></td>

				<td align="right"
					style="border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 3px 5px; color: #000; font-size: 10px;">${totalSummaryList.value.grnGvnQty}</td>
				<c:set var="hsnQty"
					value="${hsnQty+totalSummaryList.value.grnGvnQty}" />
				<td align="right"
					style="border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 3px 4px; color: #000; font-size: 10px;"><fmt:formatNumber
						type="number" groupingUsed="false" maxFractionDigits="2"
						minFractionDigits="2" value="${totalSummaryList.value.taxableAmt}" /></td>
				<td align="right"
					style="border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 3px 4px; color: #000; font-size: 10px;"><fmt:formatNumber
						type="number" groupingUsed="false" maxFractionDigits="2"
						minFractionDigits="2" value="${totalSummaryList.value.cgstPer}" /></td>
				<c:set var="hsnTaxableAmt"
					value="${hsnTaxableAmt+totalSummaryList.value.taxableAmt}" />
				<td align="right"
					style="border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 3px 5px; color: #000; font-size: 10px;"><fmt:formatNumber
						type="number" groupingUsed="false" maxFractionDigits="2"
						minFractionDigits="2" value="${totalSummaryList.value.cgstRs}" /></td>
				<td align="right"
					style="border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 3px 5px; color: #000; font-size: 10px;"><fmt:formatNumber
						type="number" groupingUsed="false" maxFractionDigits="2"
						minFractionDigits="2" value="${totalSummaryList.value.sgstPer}" /></td>
				<c:set var="hsnTotalCgst"
					value="${hsnTotalCgst+totalSummaryList.value.cgstRs}" />
				<td align="right"
					style="border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 3px 5px; color: #000; font-size: 10px;"><fmt:formatNumber
						type="number" groupingUsed="false" maxFractionDigits="2"
						minFractionDigits="2" value="${totalSummaryList.value.sgstRs}" /></td>
				<td align="right"
					style="border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 3px 5px; color: #000; font-size: 10px;"><fmt:formatNumber
						type="number" groupingUsed="false" maxFractionDigits="2"
						minFractionDigits="2"
						value="${totalSummaryList.value.taxableAmt+totalSummaryList.value.cgstRs+totalSummaryList.value.sgstRs}" /></td>
				<c:set var="hsnTotal"
					value="${hsnTotal+totalSummaryList.value.taxableAmt+totalSummaryList.value.cgstRs+totalSummaryList.value.sgstRs}" />
				<c:set var="hsnTotalSgst"
					value="${hsnTotalSgst+totalSummaryList.value.sgstRs}" />
		...
		<tr>
			...
			<td align="right"
				style="border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 3px 5px; color: #000; font-size: 10px;"><b><fmt:formatNumber
						type="number" groupingUsed="false" maxFractionDigits="2"
						minFractionDigits="2" value="${hsnTotal}" var="hsnFinalTotal" />${hsnFinalTotal}</b></td>
		...
		<tr>
			<td colspan="6" width="50%"
				style="border-left: 1px solid #313131; padding: 8px; color: #000; font-size: 15px;">&nbsp;In
				Words-<b>${Currency.convertToIndianCurrency(hsnFinalTotal)}</b>
			</td>
		</tr>
    ...
    <td colspan="5" width="38%" rowspan="2" style="border-left:1px solid #313131; padding:8px;color:#000;font-size:15px;">&nbsp;</td>
		...
		<tr>
			<td colspan="6" width="50%"
				style="border-left: 1px solid #313131; padding: 8px; color: #000; font-size: 15px;">&nbsp;</td>
		</tr>
