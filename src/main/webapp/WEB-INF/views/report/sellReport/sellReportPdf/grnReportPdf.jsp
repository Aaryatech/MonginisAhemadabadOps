		...
		<tbody>
			...
			<c:forEach items="${reportList}" var="reportList" varStatus="count">
				<tr>
					...
					<td style="text-align: right"><fmt:formatNumber type="number"
							maxFractionDigits="2" minFractionDigits="2"
							value="${reportList.aprGrandTotal}" /></td>

					<c:set var="qty" value="${qty+reportList.grnGvnQty }" />

					<c:set var="aprQty" value="${aprQty+reportList.aprQtyAcc }" />
					...
					<c:set var="taxableAmt"
						value="${taxableAmt+reportList.taxableAmt }" />
					...
					<td style="text-align: right"><fmt:formatNumber type="number"
							maxFractionDigits="2" minFractionDigits="2"
							value="${reportList.aprTaxableAmt}" /></td>
					<c:set var="aprTaxable"
						value="${aprTaxable + reportList.aprTaxableAmt}" />

					<td style="text-align: right"><fmt:formatNumber type="number"
							maxFractionDigits="2" minFractionDigits="2"
							value="${reportList.aprCgstRs}" /></td>
					<c:set var="cgst" value="${cgst + reportList.aprCgstRs}" />

					<td style="text-align: right"><fmt:formatNumber type="number"
							maxFractionDigits="2" minFractionDigits="2"
							value="${reportList.aprSgstRs}" /></td>
					<c:set var="sgst" value="${sgst + reportList.aprSgstRs}" />

					<td style="text-align: right"><fmt:formatNumber type="number"
							maxFractionDigits="2" minFractionDigits="2"
							value="${reportList.aprIgstRs}" /></td>
			...
			<tr>
				...
				<td style="text-align: right"><b><fmt:formatNumber
							type="number" maxFractionDigits="2" value="${aprTotal}" /></b></td>

				<%-- <td colspan='4'><b>Total</b></td>
				<td style="text-align: right"><b><fmt:formatNumber
							type="number" maxFractionDigits="2" value="${taxableAmt}" /></b></td>
				<td style="text-align: right"><b><fmt:formatNumber
							type="number" maxFractionDigits="2" value="${taxAmount}" /></b></td>
				<td style="text-align: right"><b><fmt:formatNumber
							type="number" maxFractionDigits="2" value="${total}" /></b></td>
				<td style="text-align: right"><b><fmt:formatNumber
							type="number" maxFractionDigits="2" value="${igst}" /></b></td>
				<td style="text-align: right"><b><fmt:formatNumber
							type="number" maxFractionDigits="2" value="${cgst}" /></b></td>
				<td style="text-align: right"><b><fmt:formatNumber
							type="number" maxFractionDigits="2" value="${sgst}" /></b></td>
				<td style="text-align: right"><b><fmt:formatNumber
							type="number" maxFractionDigits="2" value="${igst}" /></b></td>
				<td style="text-align: right"><b><fmt:formatNumber
							type="number" maxFractionDigits="2" value="${aprTotal}" /></b></td> --%>
